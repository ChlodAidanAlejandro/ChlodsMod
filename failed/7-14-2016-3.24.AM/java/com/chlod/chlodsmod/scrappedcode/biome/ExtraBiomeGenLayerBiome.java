package com.chlod.chlodsmod.scrappedcode.biome;
/*package com.chlod.scrappedcode.biome;
...
public class ExtraBiomeGenLayerBiome extends GenLayer
{
    ...
    public ExtraBiomeGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
    {
        super(p_i2122_1_);
        ...
        else
        {
            ...
            desertBiomes.add(new BiomeEntry(BiomeGenBase.plains, 10));
            desertBiomes.add(new BiomeEntry(BiomeRegistry.ExtraBiome, 10));
        }
    }
